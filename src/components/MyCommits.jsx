    ...
    <div className="mt-0 ">
      <div className="flex items-center justify-between p-2 mt-0 rounded-lg">
        <div className="w-48 pb-2 mt-0 mr-2 bg-white rounded-lg h-54">
          <h3 className="mb-0 text-lg font-bold text-center text-yellow">{totalCommits} Opensource Commits</h3>
        ...
        <div className="w-48 bg-white rounded-lg h-54">
          <h3 className="mt-2 mb-0 text-lg font-bold text-center text-yellow">{donutBoxes} Donut Boxes</h3>
          <img src={donutBoxFull} alt="Donut box full" className="w-20 h-24 mx-auto mt-2" />

...
const NavBar = () => {
  ...
  return (
    <nav className="p-0.5 bg-gradient-to-r from-primary to-secondary">
      <div className="flex items-center justify-between w-full pl-1 pr-1 mx-auto bg-gray-900 border-gray-300 rounded-lg">
        <Link to="/" className="flex items-center space-x-3">
          <h1 className="self-center p-3 pb-2 mt-2 xs:text-m sm:text-l md:text-xl lg:text-2xl">Donut Dashboard

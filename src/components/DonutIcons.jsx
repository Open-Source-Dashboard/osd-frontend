...
import outline4 from '../assets/donut-icons/outline/4.png';
import outline5 from '../assets/donut-icons/outline/5.png';
import outline6 from '../assets/donut-icons/outline/6.png';
// color donut icons
...
export const Outline2 = () => {
  return <img src={outline2} alt='outlined donut' />;
};
export const Outline3 = () => {
  return <img src={outline3} alt='outlined donut' />;
};
export const Outline4 = () => {
  return <img src={outline4} alt='outlined donut' />;
};
export const Outline5 = () => {
  return <img src={outline5} alt='outlined donut' />;
};
export const Outline6 = () => {
  return <img src={outline6} alt='outlined donut' />;
};

...
const Dashboard = () => {
  ...
  return (
    <div className="grid h-screen gap-4 m-3 mt-0" style={{ gridTemplateRows: 'repeat(12, 1fr)', gridTemplateColumns: 'repeat(18, 1fr)' }}>
      ...
      <div className="col-span-6 row-span-4 p-2 mt-6 border-4 border-white rounded-lg bg-violet-950 ">
        <FeaturedProject />
        </div>
      <div className="col-span-2 row-span-4 p-2 mb-5 ">
        <NavLeft />
      </div>
      <div className="col-span-10 p-3 bg-gray-400 rounded-lg row-span-8 p-">
      ...
      <div className="col-span-6 row-span-6 p-2 border-4 border-white rounded-lg bg-violet-950">
        <PeruseProjects />
      </div>
      <div className="col-span-12 row-span-3 p-2 overflow-hidden rounded-lg bg-violet-950">
        <MapOfUsers />
      </div>
      <div className="col-span-6 row-span-2 p-2 overflow-scroll rounded-lg bg-violet-950">
        <LatestContributors />
      </div>
    </div>
  );
